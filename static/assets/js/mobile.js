  ...
  (function (e, t, n, r) {
      ...
      e.extend(e.mobile, {
        ...
        getAttribute: function (t, n) {
          ...
          (t = t.jquery ? t[0] : t),
            t &&
              t.getAttribute &&
              (r = t.getAttribute("data-" + e.mobile.ns + n));
          try {
            r =
              r === "true"
                ? !0
        ...
        (e.jqmData = function (t, n, r) {
          ...
          return (
            typeof n != "undefined" &&
              (i = e.data(t, n ? e.mobile.nsNormalize(n) : n, r)),
            i
          );
        }),
    ...
    (function (e, t, r) {
      var i = function (t, n) {
        ...
        return (
          o.length === 0 && s.length > 0 && (i = i.concat(s.toArray())),
      ...
      e.extend(e.mobile, {
        ...
        haveParents: function (t, n) {
          ...
          for (a = 0; a < r; a++) {
            ...
            while (s) {
              f = s.getAttribute
                ? s.getAttribute("data-" + e.mobile.ns + n)
                : "";
              if (f === "false") {
                u = !0;
                break;
    ...
    (function (e, r) {
        ...
        var n = t,
          r =
            ...
            !!n.document.createElementNS("http://www.w3.org/2000/svg", "svg")
              .createSVGRect &&
            (!n.opera || navigator.userAgent.indexOf("Chrome") !== -1),
          i = function (t) {
      ...
      function p() {
        ...
        for (l in f)
          a.style[l] !== r &&
            ((a.style[l] = "translate3d( 100px, 1px, 1px )"),
      ...
      function d() {
        ...
        return (
          n.length
            ? (i = n.attr("href"))
            : (n = r = e("<base>", { href: t }).appendTo("head")),
      ...
      function g() {
        var e = t,
          ...
          f = !!a && a[1];
        return ((r.indexOf("iPhone") > -1 ||
          r.indexOf("iPad") > -1 ||
          r.indexOf("iPod") > -1) &&
          s &&
          s < 534) ||
          (e.operamini &&
            {}.toString.call(e.operamini) === "[object OperaMini]") ||
          (a && f < 7458) ||
          (n.indexOf("Android") > -1 && s && s < 533) ||
          (u && u < 6) ||
          ("palmGetResource" in t && s && s < 534) ||
      ...
      e.extend(e.mobile, { browser: {} }),
        ...
        e.extend(e.support, {
          pushState:
            ...
            t.navigator.userAgent.search(/CriOS/) === -1,
        ...
        (e.mobile.gradeA = function () {
          return (
            ...
            (e.support.boundingRect ||
              e.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/) !== null)
          );
        }),
